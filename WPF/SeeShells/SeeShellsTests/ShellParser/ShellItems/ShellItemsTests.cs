...
namespace SeeShellsTests.ShellParser.ShellItems
{
    ...
    public class ShellItemsTests
    {
        ...
        public void ShellItem0x74InvalidDateTest()
        {
            ...
            //0x74 type which should has a defined type name but produces an exception.
            //Because of an invalid DateTime in the extensionBlock, during normal usage an exception was thrown, causing TypeName not to be set
            //because typeName isnt set, getAllProperties returns an error for an null parameter.
            byte[] value =
            {
